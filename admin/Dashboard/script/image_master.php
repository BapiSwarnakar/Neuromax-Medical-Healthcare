<script type="text/javascript">
  $(document).ready(function(){
    $('#main_images_form').parsley();
    $('#main_images_form').on('submit',function(event){
    if($('#main_images_form').parsley().validate())
    {
      $.ajax({
            ...
            beforeSend:function()
            {
              $('#main_image_btn').val('Please wait..');
              $('#main_image_btn').attr('disabled',true);
            },
            success:function(data)
            {
              if(data.success)
              {
                ...
                $('#main_images_form')[0].reset();
                $('#main_image_btn').val('Submit');
                $('#main_image_btn').attr('disabled',false);
                setTimeout(function(){
                  location.reload();
                }, 2000);
  ...
  $('#Sub_images_form').parsley();
    $('#Sub_images_form').on('submit',function(event){
    if($('#Sub_images_form').parsley().validate())
    {
      $.ajax({
            url:"../../action-page/admin_ajax_action.php",
            method:"POST",
    ...
    All_Images();
      ...
      function All_Images()
      {
          $.ajax({
            ...
            type : "POST",
            data : {
              page : "All_Font_Images_Show",
              action :"All_Font_Images_Show"
            },
            success : function(data){
  ...
  All_Sub_Images();
  function All_Sub_Images()
      {
          $.ajax({
            url : "../../action-page/admin_ajax_action.php",
            type : "POST",
            data : {
              page : "All_Sub_Images_Show",
              action :"All_Sub_Images_Show"
            },
            success : function(data){
              $('#image_sub_data').html(data);
              $("#sub_image_table").DataTable({
                "responsive": true,
                "autoWidth": false,
             });
            }
   ...
   $(document).on('click','.Delete_Images',function(event){
    ...
    if(conn==true)
    {
      $.ajax({
        ...
        type : "POST",
        data:{
          page : "Delete_Images_Unic",
          action  : "Delete_Images_Unic",
          id : id,
  ...
  $(document).on('click','.Delete_Sub_Images',function(event){
    ...
    if(conn==true)
    {
      $.ajax({
        ...
        type : "POST",
        data:{
          page : "Delete_Sub_Images_Unic",
          action  : "Delete_Sub_Images_Unic",
          id : id,
          image_name:image_name
        },
        dataType : "json",
