...
if(isset($_GET['id']) && !empty($_GET['id']))
{
	...
	if($row =$server->All_Record($sql))
    {
	   ...
	   echo $data;
    	...
    	else
    	{
    	    ...
    	    header("location:all_success_patient.php");
    	}
  ...
  else
  {
     ...
     echo "<script>window.location='all_success_patient.php'</script>";
